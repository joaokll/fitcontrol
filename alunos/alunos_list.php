...
<div>
    ...
    <a href="aluno_form.php">+ Novo Aluno</a>
</div>
    ...
    <table>
        ...
        <?php foreach ($alunos as $a) : ?>
            <tr>
                ...
                <td>
                    <a href="../mensalidades/mensalidades_list.php?aluno_id=<?= $a['id'] ?>">Mensalidades</a>
                    <a href="../fichas/fichas_list.php?aluno_id=<?= $a['id'] ?>">Fichas</a>
                    <a href="aluno_form.php?id=<?= $a['id'] ?>">Editar</a>
                    <a href="aluno_delete.php?id=<?= $a['id'] ?>" onclick="return confirm('Tem certeza que deseja excluir este aluno? Todas as mensalidades e fichas dele também serão excluídas.')">Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
