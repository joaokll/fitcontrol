...
if ($id) {
    ...
    if (!$exercicio) {
        header('Location: /src/fichas/fichas_listar.php');
        exit;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nome === '') {
        ...
        header('Location: /src/fichas/fichas_view.php?id=' . $ficha_id . '&msg=' . urlencode('Exercício salvo com sucesso!'));
        exit;
    }
...
<div>
    ...
    <form method="post">
        ...
        <div>
            ...
            <a href="fichas_view.php?id=<?= $ficha_id ?>">Cancelar</a>
        </div>
    </form>
</div>
