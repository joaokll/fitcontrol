...
if ($id) {
    ...
    if (!$mensalidade) {
        header('Location: mensalidades_list.php');
        exit;
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($aluno_id === '' || $valor === '' || $vencimento === '') {
        $erro = 'Preencha aluno, valor e vencimento.';
    } else {
        ...
        header('Location: mensalidades_list.php?msg=' . urlencode('Mensalidade salva com sucesso!'));
        exit;
    }
...
<div>
    ...
    <form method="post">
        ...
        <div>
            ...
            <a href="mensalidades_list.php">Cancelar</a>
        </div>
    </form>
</div>
